...
cycles = [534540, 373290, 386248, 370916, 375541]
x_labels = [f"{b} bank, {w}-way" if b == 1 else f"{b} banks, {w}-way" for b, w in zip(banks, ways_per_bank)]
...
ax.set_title("Pixel Shader Banking Sweep: Cycles vs Banks and Associativity per Bank",
             fontsize=18, fontweight='bold', pad=20)
ax.set_xlabel("D$ banking / associativity per bank",
