...
def get_test_output_dir():
    ...
    # Navigate to gpu/gpu/ directory (5 levels up from tests/simulator/backend/execute/ex_stage_test.py)
    # execute -> backend -> simulator -> tests -> gpu/gpu
...
def dump_performance_counters(ex_stage, output_dir=None):
...
def main():
    ...
    # Save console output to timestamped directory
    output_dir = get_test_output_dir()
    output_dir.mkdir(parents=True, exist_ok=True)
    
    output_file = output_dir / "ex_stage_test_output.ansi"
