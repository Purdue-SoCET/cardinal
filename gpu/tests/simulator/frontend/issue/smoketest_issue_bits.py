...
def test_SMOKE_1(i: int) -> int:
    fust["ADD"] = 1
    Instructions = [
        Instruction(pc=Bits(uint=0x0, length=32), intended_FU="ADD", warp_id=0, warp_group_id=0, rs1=Bits(uint=10, length=32), rs2=Bits(uint=11, length=32), rd=Bits(uint=12, length=32), num_operands = 2, opcode="0000000", rdat1=0, rdat2=0, wdat=0, predicate=[Bits(uint=1, length=1)], issued_cycle=None, stage_entry={}, stage_exit={}, fu_entries=[], wb_cycle=None, target_bank=None),
        Instruction(pc=Bits(uint=0x0, length=32), intended_FU="ADD", warp_id=1, warp_group_id=0, rs1=Bits(uint=10, length=32), rs2=Bits(uint=11, length=32), rd=Bits(uint=12, length=32), num_operands = 2, opcode="0000000", rdat1=0, rdat2=0, wdat=0, predicate=[Bits(uint=1, length=1)], issued_cycle=None, stage_entry={}, stage_exit={}, fu_entries=[], wb_cycle=None, target_bank=None),
        Instruction(pc=Bits(uint=0x4, length=32), intended_FU="SUB", warp_id=0, warp_group_id=0, rs1=Bits(uint=5, length=32), rs2=Bits(uint=6, length=32), rd=Bits(uint=7, length=32), num_operands = 2, opcode="0000001", rdat1=0, rdat2=0, wdat=0, predicate=[Bits(uint=1, length=1)], issued_cycle=None, stage_entry={}, stage_exit={}, fu_entries=[], wb_cycle=None, target_bank=None),
        Instruction(pc=Bits(uint=0x4, length=32), intended_FU="SUB", warp_id=1, warp_group_id=0, rs1=Bits(uint=5, length=32), rs2=Bits(uint=6, length=32), rd=Bits(uint=7, length=32), num_operands = 2, opcode="0000001", rdat1=0, rdat2=0, wdat=0, predicate=[Bits(uint=1, length=1)], issued_cycle=None, stage_entry={}, stage_exit={}, fu_entries=[], wb_cycle=None, target_bank=None),
        Instruction(pc=Bits(uint=0x8, length=32), intended_FU="MUL", warp_id=0, warp_group_id=0, rs1=Bits(uint=20, length=32), rs2=Bits(uint=21, length=32), rd=Bits(uint=30, length=32), num_operands = 2, opcode="0000010", rdat1=0, rdat2=0, wdat=0, predicate=[Bits(uint=1, length=1)], issued_cycle=None, stage_entry={}, stage_exit={}, fu_entries=[], wb_cycle=None, target_bank=None),
        Instruction(pc=Bits(uint=0x8, length=32), intended_FU="MUL", warp_id=1, warp_group_id=0, rs1=Bits(uint=20, length=32), rs2=Bits(uint=21, length=32), rd=Bits(uint=30, length=32), num_operands = 2, opcode="0000010", rdat1=0, rdat2=0, wdat=0, predicate=[Bits(uint=1, length=1)], issued_cycle=None, stage_entry={}, stage_exit={}, fu_entries=[], wb_cycle=None, target_bank=None),
        Instruction(pc=Bits(uint=0xC, length=32), intended_FU="DIV", warp_id=0, warp_group_id=0, rs1=Bits(uint=40, length=32), rs2=Bits(uint=41, length=32), rd=Bits(uint=42, length=32), num_operands = 2, opcode="0000011", rdat1=0, rdat2=0, wdat=0, predicate=[Bits(uint=1, length=1)], issued_cycle=None, stage_entry={}, stage_exit={}, fu_entries=[], wb_cycle=None, target_bank=None),
        Instruction(pc=Bits(uint=0xC, length=32), intended_FU="DIV", warp_id=1, warp_group_id=0, rs1=Bits(uint=40, length=32), rs2=Bits(uint=41, length=32), rd=Bits(uint=42, length=32), num_operands = 2, opcode="0000011", rdat1=0, rdat2=0, wdat=0, predicate=[Bits(uint=1, length=1)], issued_cycle=None, stage_entry={}, stage_exit={}, fu_entries=[], wb_cycle=None, target_bank=None)
    ]
    print("================================== SMOKE TEST1 ==================================")
    ...
    for cycle in range(len(Instructions)):
        ...
        if   (cycle==0):
            ...
            assert issue_stage.iBufferCapacity[0] == 1
            assert issue_stage.staged_even.pc.uint == 0x0
            ...
            assert issue_stage.staged_even.rs1.uint == 10
            assert issue_stage.staged_even.rs2.uint == 11
            assert issue_stage.staged_even.rd.uint == 12
            assert issue_stage.staged_odd == None
            assert len(issue_stage.ready_to_dispatch) == 0
        elif (cycle==2):
            assert issue_stage.iBufferCapacity[0] == 1
            ...
            assert issue_stage.staged_even.rs2.uint == 11
            assert issue_stage.staged_even.rd.uint == 12
            assert issue_stage.staged_odd.pc.uint == 0x0
            ...
            assert issue_stage.staged_odd.rs1.uint == 10
            assert issue_stage.staged_odd.rs2.uint == 11
            assert issue_stage.staged_odd.rd.uint == 12
            assert len(issue_stage.ready_to_dispatch) == 0
        elif (cycle==3):
            assert issue_stage.iBufferCapacity[0] == 1
            assert issue_stage.staged_even.pc.uint == 0x4
            assert issue_stage.staged_even.intended_FU == "SUB"
            assert issue_stage.staged_even.warp_id == 0
            assert issue_stage.staged_even.warp_group_id == 0
            assert issue_stage.staged_even.rs1.uint == 5
            assert issue_stage.staged_even.rs2.uint == 6
            assert issue_stage.staged_even.rd.uint == 7
            assert issue_stage.staged_odd.pc.uint == 0x0
            assert issue_stage.staged_odd.intended_FU == "ADD"
            assert issue_stage.staged_odd.warp_id == 1
            assert issue_stage.staged_odd.warp_group_id == 0
            ...
            assert issue_stage.staged_odd.rs2.uint == 11
            assert issue_stage.staged_odd.rd.uint == 12
            assert issue_stage.ready_to_dispatch[0].pc.uint == 0x0
            ...
            assert issue_stage.ready_to_dispatch[0].rs1.uint == 10
            assert issue_stage.ready_to_dispatch[0].rs2.uint == 11
            assert issue_stage.ready_to_dispatch[0].rd.uint == 12
        elif (cycle==4):
